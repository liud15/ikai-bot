...
// En Linux, /tmp es tmpfs (RAM limitada). Usamos una carpeta en el disco del proyecto.
// Se puede sobreescribir con la variable de entorno IKAI_TMP_DIR o BOT_TMP_DIR.
const defaultTmpDir = process.platform === 'win32'
  ? join(tmpdir(), 'ikai-bot')
